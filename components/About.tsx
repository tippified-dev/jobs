          ...
          >
            ...
            <div className="relative">
              ...
              <div className="mt-6 space-y-5 text-base leading-7 text-slate-300">
                <p>
                  Every day, thousands of people search for ways to earn, build
                  their careers and find better employment opportunities. Yet
                  the online job market can be overwhelming, with opportunities
