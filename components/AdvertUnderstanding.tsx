...
export default function AdvertUnderstanding() {
  ...
  return (
    <>
      <div
        className="fixed inset-0 z-9998 bg-slate-950/70 backdrop-blur-sm"
        aria-hidden="true"
      />
          ...
          <div className="mt-5 flex flex-col gap-4 border-t border-slate-100 pt-4 sm:flex-row sm:items-center">
            ...
            <div className="flex w-full items-center justify-end gap-2 sm:ml-auto sm:w-auto">
              ...
              <button
                ...
                autoFocus
                className="inline-flex items-center justify-center rounded-xl bg-slate-900 px-5 py-2.5 text-xs font-semibold text-white shadow-sm transition hover:bg-blue-600 sm:text-sm"
              >
                I understand
              </button>
            </div>
